/// Pure-Dart byte-level decoders for CUE sheets.
///
...
///
/// This library has no platform imports (no `dart:io`, no `dart:html`) so
/// it runs on every Dart platform, including the browser. Filesystem
/// loading lives in a separate library behind conditional imports
/// (see `file_io.dart`).
library;
...
///
/// Decoding order: byte-order mark detection first (UTF-8, UTF-16 LE,
/// UTF-16 BE), then [encoding] (default UTF-8), then Latin-1 as a lossless
/// fallback.
